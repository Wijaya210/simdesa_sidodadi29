            ...
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="{{ $index * 100 }}">
                <div class="glass-card h-100 p-0 overflow-hidden d-flex flex-column">
                    <div class="position-relative">
                        @if($program->gambar)
                            <img src="{{ asset('images/program_bantuan/' . $program->gambar) }}" class="w-100"
                                alt="{{ $program->nama_program }}" style="height: 220px; object-fit: cover;">
                        @else
                    ...
                    <div class="p-4 flex-grow-1 d-flex flex-column">
                        ...
                        <button type="button" class="btn btn-outline-primary w-100 fw-bold rounded-pill" data-bs-toggle="modal"
                            data-bs-target="#detailModal{{ $program->id }}">
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
                        ...
                        <div class="modal-body p-0">
                            @if($program->gambar)
                                <img src="{{ asset('images/program_bantuan/' . $program->gambar) }}" class="w-100"
                                    alt="{{ $program->nama_program }}" style="max-height: 350px; object-fit: cover;">
                            @endif
                            <div class="p-4">
