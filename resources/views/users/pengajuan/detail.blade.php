    ...
    <div class="col-lg-8">
        ...
        <div class="glass-card">
            ...
            <div class="mb-4">
                ...
                <div class="bg-light p-4 rounded-4">
                    <div class="row mb-2">
                        ...
                        <div class="col-md-8 fw-bold text-primary">{{ strtoupper(str_replace('_', ' ', $pengajuan->jenis_surat)) }}</div>
                    </div>
                    <div class="row">
            ...
            <div class="mt-5 text-center">
                <a href="{{ route('surat-pengajuan.download', $pengajuan->id) }}" class="btn btn-success btn-lg px-5 shadow-lg">
