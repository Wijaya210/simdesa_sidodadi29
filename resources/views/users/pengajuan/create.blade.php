...
<div class="row justify-content-center" data-aos="fade-up">
    <div class="col-lg-10">
        ...
        <div class="glass-card">
            ...
            <form id="formPengajuan" action="{{ route('surat-pengajuan.store') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <div class="mb-5">
                    <label for="jenisSurat" class="form-label fw-bold h5 text-primary mb-3">Pilih Jenis Surat</label>
                    <select class="form-select form-select-lg" id="jenisSurat" name="jenis_surat" required onchange="tampilkanForm()">
                        <option value="" selected disabled>Pilih salah satu...</option>
                        <option value="nikah">Surat Pengantar Nikah</option>
                        <option value="pindah">Surat Keterangan Pindah (Keluar)</option>
                        <option value="tanah">Surat Keterangan Riwayat Tanah</option>
                ...
                <div id="kontenFormDinamis" style="display: none;">
                    ...
                    <div class="card border-0 bg-light rounded-4 mb-4 p-4">
                        <h5 class="fw-bold text-primary mb-4"><i class="fas fa-file-upload me-2"></i>1. Dokumen Persyaratan</h5>
