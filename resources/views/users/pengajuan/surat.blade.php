            ...
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    @forelse($pengajuans as $index => $pengajuan)
                        <tr>
                            <td>{{ $index + 1 }}</td>
                            <td class="fw-bold text-primary">{{ strtoupper(str_replace('_', ' ', $pengajuan->jenis_surat)) }}
                            </td>
                            ...
                            <td>
                                <a href="{{ route('surat-pengajuan.detail', $pengajuan->id) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center py-5 text-muted">
                                ...
                                <a href="{{ route('surat-pengajuan.create') }}" class="btn btn-sm btn-outline-primary">Ajukan
                                    Sekarang</a>
                            </td>
                        </tr>
                    @endforelse
