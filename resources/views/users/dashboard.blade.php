    ...
    <div class="row g-4 mb-5">
        <div class="col-md-3" data-aos="fade-up" data-aos-delay="100">
            <div class="glass-card h-100 text-center py-4">
                ...
                <h3 class="h2 fw-bold mb-1">{{ $stats['total_warga'] }}</h3>
        ...
        <div class="col-md-3" data-aos="fade-up" data-aos-delay="200">
            <div class="glass-card h-100 text-center py-4">
                ...
                <h3 class="h2 fw-bold mb-1">{{ $stats['total_admin'] }}</h3>
        ...
        <div class="col-md-3" data-aos="fade-up" data-aos-delay="300">
            <div class="glass-card h-100 text-center py-4">
                ...
                <h3 class="h2 fw-bold mb-1">{{ $stats['total_pengaduan'] }}</h3>
        ...
        <div class="col-md-3" data-aos="fade-up" data-aos-delay="400">
            <div class="glass-card h-100 text-center py-4">
                ...
                <h3 class="h2 fw-bold mb-1">{{ $stats['total_bantuan'] }}</h3>
                ...
                <div class="row g-3">
                    <div class="col-6">
                        <div class="border rounded p-3 text-center h-100 bg-white">
                            <h5 class="fw-bold text-primary mb-1">{{ $stats['luas_wilayah'] }} km²</h5>
                            <small class="text-muted">Luas Wilayah</small>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="border rounded p-3 text-center h-100 bg-white">
                            <h5 class="fw-bold text-primary mb-1">{{ $stats['total_warga'] }}</h5>
