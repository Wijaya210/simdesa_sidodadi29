    ...
    <div class="col-md-4" data-aos="fade-up">
        <div class="glass-card h-100 p-0 overflow-hidden d-flex flex-column">
            <div class="position-relative">
                @if($program->gambar)
                    <img src="{{ asset('storage/' . $program->gambar) }}" class="w-100" alt="{{ $program->nama_program }}" style="height: 200px; object-fit: cover;">
                @else
                ...
                <div class="position-absolute top-0 end-0 m-2">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
                            <li>
                                <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#editModal{{ $program->id }}">
                            ...
                            <li>
                                <form action="{{ route('admin.program-bantuan.destroy', $program->id) }}" method="POST">
                                    @csrf @method('DELETE')
                                    <button class="dropdown-item text-danger" onclick="return confirm('Hapus program ini?')">
    ...
    <div class="modal fade" id="editModal{{ $program->id }}" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content border-0 shadow-lg rounded-4">
                ...
                <form action="{{ route('admin.program-bantuan.update', $program->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf @method('PUT')
                    <div class="modal-body bg-light">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="deskripsi" class="form-control" rows="4" required>{{ $program->deskripsi }}</textarea>
                        </div>
                        <div class="mb-3">
        ...
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <form action="{{ route('admin.program-bantuan.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body bg-light">
                    <div class="mb-3">
                        <label class="form-label fw-bold">Nama Program</label>
                        <input type="text" name="nama_program" class="form-control" required placeholder="Contoh: BLT Dana Desa">
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Deskripsi</label>
                        <textarea name="deskripsi" class="form-control" rows="4" required placeholder="Jelaskan detail program..."></textarea>
                    </div>
                    <div class="mb-3">
