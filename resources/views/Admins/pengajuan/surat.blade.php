                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center">
                            ...
                            <span class="fw-bold">{{ $s->user->name }}</span>
                        </div>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        @elseif($s->status == 'disetujui' || $s->status == 'approved')
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="{{ route('admin.surat.show', $s->id) }}" class="btn btn-sm btn-info text-white" title="Lihat Detail">
                                <i class="fas fa-eye"></i>
                            </a>
                            <form action="{{ route('admin.surat.delete', $s->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Hapus surat ini?')">
                                @csrf @method('DELETE')
