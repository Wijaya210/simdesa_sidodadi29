...
@section('content')
<!-- Hero Section -->
<div class="row align-items-center min-vh-75 mb-5" data-aos="fade-up">
    <div class="col-lg-6 text-center text-lg-start">
        <h1 class="display-3 fw-bold mb-4 text-primary">Selamat Datang di<br>Desa Sidodadi</h1>
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-start">
            @guest
                <a href="{{ route('login') }}" class="btn btn-primary btn-lg px-5 me-md-2">
            ...
            @else
                <a href="{{ route('users.dashboard') }}" class="btn btn-primary btn-lg px-5">
    ...
    <div class="col-lg-6 text-center mt-5 mt-lg-0">
        <img src="{{ asset('images/gambar_balai_desa_sidodadi.jpg') }}" 
             class="img-fluid rounded-4 shadow-lg floating-icon" 
...
<div class="row g-4 mb-5">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
        <div class="glass-card h-100 text-center">
            <div class="mb-4">
                <i class="fas fa-hand-holding-heart fa-4x text-secondary floating-icon" style="color: var(--secondary-color);"></i>
            </div>
