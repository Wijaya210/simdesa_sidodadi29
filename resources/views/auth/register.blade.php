                    ...
                    <form action="{{ route('register.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="name" class="form-control border-start-0 ps-0" value="{{ old('name') }}" placeholder="Nama Sesuai KTP" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="nik" class="form-control border-start-0 ps-0" value="{{ old('nik') }}" placeholder="Nomor Induk Kependudukan" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="email" class="form-control border-start-0 ps-0" value="{{ old('email') }}" placeholder="nama@email.com" required>
                            </div>
                        </div>
